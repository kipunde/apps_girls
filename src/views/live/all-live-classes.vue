...
export default {
  data() {
    return {
      ...
      columns: [
        ...
        { title: "Statunt Attend", key: "file_url" },
  ...
  try {
    ...
    if (res.code === 200) {
      ...
      const allowedContentTypes = ["live-all"];
    ...
    <div class="content">
      <div class="page-header d-flex justify-content-between align-items-center mb-3">
        <div class="page-title">
          <h4>Online usere </h4>
          <h6>Manage User Live </h6>
        </div>
        <!-- <button class="btn btn-added" @click="addAttachment">
          <vue-feather type="plus-circle" class="me-2" /> Create event Live
        </button> -->
      </div>
